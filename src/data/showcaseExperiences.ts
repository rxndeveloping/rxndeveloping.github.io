...
export const showcaseExperiences:Record<string,ShowcaseExperience>={
 ...
 'nox-social-club/rooms':e('catalog',[
  i(c('The Listening Room','La Sala d’ascolto','La Salle d’écoute','La Sala de escucha'),'48 PEOPLE · ANALOG SOUND',c('A seated room tuned for vinyl sessions, album launches, and intimate sets.','Una sala con posti a sedere per sessioni in vinile, album launch e set intimi.','Une salle assise pour vinyles, lancements d’albums et sets intimistes.','Una sala con asientos para vinilos, lanzamientos y sesiones íntimas.'),undefined,undefined,'/assets/showcases/nox/listening-room-v2.webp'),
  i(c('The Red Bar','Il Red Bar','Le Red Bar','El Red Bar'),'70 PEOPLE · COCKTAIL SERVICE',c('Counter seating, lounge tables, and the complete cocktail programme.','Banco, tavoli lounge e programma cocktail completo.','Comptoir, tables lounge et programme cocktails complet.','Barra, mesas lounge y programa completo de cócteles.'),undefined,undefined,'/assets/showcases/nox/bar.jpg'),
  i(c('The Basement','Il Basement','Le Sous-sol','El Sótano'),'180 PEOPLE · LIVE STAGE',c('A flexible live room with stage, booth, and independent access.','Una sala live flessibile con palco, booth e accesso indipendente.','Une salle live modulable avec scène, cabine et accès indépendant.','Una sala flexible con escenario, cabina y acceso independiente.'),undefined,undefined,'/assets/showcases/nox/neon.jpg')]),
 ...
 'marea-beach-club/beach':e('booking',[
  i(c('Front-row cabana','Cabana prima fila','Cabane première ligne','Cabaña primera fila'),'2—4 GUESTS · €180',undefined,180,undefined,'/assets/showcases/marea/experiences-v2/front-row-cabana.webp'),
  i(c('Family garden','Giardino famiglia','Jardin famille','Jardín familiar'),'4—6 GUESTS · €135',undefined,135,undefined,'/assets/showcases/marea/experiences-v2/family-garden.webp'),
  i(c('Quiet deck','Quiet deck','Pont calme','Terraza tranquila'),'2 GUESTS · €90',undefined,90,undefined,'/assets/showcases/marea/experiences-v2/quiet-deck.webp')]),
 'marea-beach-club/wellness':e('schedule',[
  i(c('Sunrise mobility','Mobilità all’alba','Mobilité à l’aube','Movilidad al amanecer'),'07:00 · 12 PLACES · €22',undefined,undefined,undefined,'/assets/showcases/marea/experiences-v2/sunrise-mobility.webp'),
  i(c('Coastal recovery','Recovery costiero','Récupération côtière','Recuperación costera'),'11:30 · 6 PLACES · €48',undefined,undefined,undefined,'/assets/showcases/marea/experiences-v2/coastal-recovery.webp'),
  i(c('Sunset breathwork','Respiro al tramonto','Respiration au coucher du soleil','Respiración al atardecer'),'19:00 · 16 PLACES · €18',undefined,undefined,undefined,'/assets/showcases/marea/experiences-v2/sunset-breathwork.webp')]),
 'marea-beach-club/events':e('schedule',[
  i(c('Full Moon Table','Tavola di luna piena','Table de pleine lune','Mesa de luna llena'),'18 AUG · 20:30 · €95',undefined,undefined,undefined,'/assets/showcases/marea/experiences-v2/full-moon-table.webp'),
  i(c('Coastline Sessions','Coastline Sessions','Coastline Sessions','Coastline Sessions'),'23 AUG · 18:00 · €28',undefined,undefined,undefined,'/assets/showcases/marea/experiences-v2/coastline-sessions.webp'),
  i(c('Guest chef: Ada Serra','Chef ospite: Ada Serra','Cheffe invitée : Ada Serra','Chef invitada: Ada Serra'),'31 AUG · 20:00 · €120',undefined,undefined,undefined,'/assets/showcases/marea/experiences-v2/guest-chef-ada-serra.webp')]),
 'marea-beach-club/private-hire':e('booking',[
  i(c('Sunset ceremony','Cerimonia al tramonto','Cérémonie au coucher du soleil','Ceremonia al atardecer'),'40—90 GUESTS · FROM €4,800',undefined,4800,undefined,'/assets/showcases/marea/experiences-v2/sunset-ceremony.webp'),
  i(c('Brand retreat','Brand retreat','Retraite de marque','Retiro de marca'),'20—60 GUESTS · FROM €3,200',undefined,3200,undefined,'/assets/showcases/marea/experiences-v2/brand-retreat.webp'),
  i(c('Full coastline','Costa in esclusiva','Côte en exclusivité','Costa en exclusiva'),'UP TO 240 · ON REQUEST',undefined,9000,undefined,'/assets/showcases/marea/experiences-v2/full-coastline.webp')]),
